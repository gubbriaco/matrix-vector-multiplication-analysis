...
/**
 * Sparse Matrix Multiplication Loop 2 Pipeline, Unrolling Factor=2 and Partitioning Cyclic=8 (iNonZeroEl) Design.
 ...
 */
void smvm_loop2PU2C8iNonZeroEl(int iFirstEl[rows+1], int iNonZeroEl[noZeroEl], DTYPE values[noZeroEl], DTYPE mulRes[size], DTYPE vector[size]) {
